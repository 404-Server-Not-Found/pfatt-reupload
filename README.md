# REUPLOAD
Hi, this is a reupload of user [Aus](https://github.com/aus)' guide to achieving true bridgemode with an AT&T Residential Gateway and pfSense. I [Martyfree123](https://github.com/Martyfree123) and [404 Server Not Found](https://github.com/404-Server-Not-Found/) take no credit for this guide whatsoever. I was just truely disappointed see it taken down, it's a very well layed out guide to a problem that should never have existed for users in the first place. Thanks to user [briangordon](https://github.com/briangordon) for the files!
